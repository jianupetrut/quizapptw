...
import ro.ase.codinquiz.quizapplication.Main.OtherActivities.ToDoActivity1;
...
public class TeacherSeeHistory extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_teacher_see_history);
    ...
    public void navigateToDownloadStudents(View view) {
        Intent intent =
                new Intent(TeacherSeeHistory.this,
                        ToDoActivity1.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.teacher_see_history, menu);
        return true;
    }
